...
function initGoogleMap() {
	...
	var myLatlng = new google.maps.LatLng(43.7763238,-79.5269118);
  ...
  var contentString = '<div id="content">'+
      '<div id="siteNotice">'+
      '</div>'+
      '<h1 id="firstHeading" class="firstHeading">RK Doors</h1>'+
      '<div id="bodyContent">'+
      '<p>71 Adesso Drive<br/>Vaughan, Ontario<br/>Canada L4K 3C7</p> ' +
      '<p><a href="https://goo.gl/maps/t6iz3yzWa6r" target="_blank" title="Get Directions to RK Doors">Get Directions</a></p>'+
      '</div>'+
      '</div>';
